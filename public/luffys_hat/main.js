...
function init_threeScene(spec) {
  ...
  // Load our cool hat
  loader.load(
    './luffys_hat/models/luffys_hat/luffys_hat.json',
    function (geometry) {
      // we create our Hat mesh
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./luffys_hat/models/luffys_hat/Texture2.jpg")
      });
      ...
      */
      maskLoader.load('./luffys_hat/models/mask/faceLowPolyEyesEarsFill2.json', function (maskBufferGeometry) {
  ...
  const frameMesh=new THREE.Mesh(threeStuffs.videoMesh.geometry,  create_mat2d(new THREE.TextureLoader().load('./luffys_hat/images/cadre_v1.png'), true))
