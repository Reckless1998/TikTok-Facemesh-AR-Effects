...
function init_threeScene(spec) {
  ...
  document.querySelector('#openMouthInstructions').style.display = 'none';
  ...
  */
  ...
  loaderAngelIntro.load(
    './angel_demon/models/angel/angel_intro.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/angel/diffuse_angel.png"),
        morphTargets: true
      });
  ...
  loaderAngelIdle.load(
    './angel_demon/models/angel/angel_idle.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/angel/diffuse_angel.png"),
        morphTargets: true
  ...
  loaderAngelFight.load(
    './angel_demon/models/angel/angel_fight.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/angel/diffuse_angel.png"),
        morphTargets: true
  ...
  */
  ...
  loaderHarpIntro.load(
    './angel_demon/models/angel/harp_intro.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/angel/harpe.jpg"),
        morphTargets: true
      });
  ...
  loaderHarpIdle.load(
    './angel_demon/models/angel/harp_idle.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/angel/harpe.jpg"),
        morphTargets: true
  ...
  loaderHarpFight.load(
    './angel_demon/models/angel/harp_fight.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/angel/harpe.jpg"),
        morphTargets: true
  ...
  */
  ...
  loaderDemonIntro.load(
    './angel_demon/models/demon/demon_intro.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/demon/diffuse_demon.png"),
        morphTargets: true
      });
  ...
  loaderDemonIdle.load(
    './angel_demon/models/demon/demon_idle.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/demon/diffuse_demon.png"),
        morphTargets: true
  ...
  loaderDemonFight.load(
    './angel_demon/models/demon/demon_fight.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/demon/diffuse_demon.png"),
        morphTargets: true
  ...
  */
  ...
  loaderForkIntro.load(
    './angel_demon/models/demon/fourche_intro.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/demon/fourche.jpg"),
        morphTargets: true
      });
  ...
  loaderForkIdle.load(
    './angel_demon/models/demon/fourche_idle.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/demon/fourche.jpg"),
        morphTargets: true
  ...
  loaderForkFight.load(
    './angel_demon/models/demon/fourche_fight.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./angel_demon/models/demon/fourche.jpg"),
        morphTargets: true
  ...
  // CREATE THE MASK
  FACEMESH = JeelizThreeHelper.create_threejsOccluder('./angel_demon/models/face/face.json');
...
function animate_idle() {
  document.querySelector('#openMouthInstructions').style.display = 'block';
