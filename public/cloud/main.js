...
function init_threeScene(spec) {
  ...
  loaderCloud.load(
    './cloud/models/cloud/cloud.json',
    (geometry) => {
      const mat = new THREE.MeshPhongMaterial({
        map: new THREE.TextureLoader().load('./cloud/models/cloud/cloud.png'),
        shininess: 2,
        specular: 0xffffff,
        opacity: 0.7,
        transparent: true
  ...
  const calqueMesh = new THREE.Mesh(threeStuffs.videoMesh.geometry,  create_mat2d(new THREE.TextureLoader().load('../cloud/images/frame_cloud.png'), true))
