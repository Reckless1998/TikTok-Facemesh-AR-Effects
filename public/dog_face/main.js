...
function apply_filter() {
  ...
  tempImage.src = './dog_face/images/texture_pink.jpg';
...
function init_threeScene(spec) {
  ...
  loaderEars.load(
    './dog_face/models/dog/dog_ears.json',
    function (geometry) {
      const mat = new THREE.FlexMaterial({
        map: new THREE.TextureLoader().load('./dog_face/models/dog/texture_ears.jpg'),
        flexMap: new THREE.TextureLoader().load('./dog_face/models/dog/flex_ears_256.jpg'),
        alphaMap: new THREE.TextureLoader().load('./dog_face/models/dog/alpha_ears_256.jpg'),
        transparent: true,
        opacity: 1,
        bumpMap: new THREE.TextureLoader().load('./dog_face/models/dog/normal_ears.jpg'),
        bumpScale: 0.0075,
        shininess: 1.5,
        specular: 0xffffff,
      });
  ...
  loaderNose.load(
    './dog_face/models/dog/dog_nose.json',
    function (geometry) {
      const mat = new THREE.MeshPhongMaterial({
        map: new THREE.TextureLoader().load('./dog_face/models/dog/texture_nose.jpg'),
        shininess: 1.5,
        specular: 0xffffff,
        bumpMap: new THREE.TextureLoader().load('./dog_face/models/dog/normal_nose.jpg'),
        bumpScale: 0.005
      });
  ...
  loaderTongue.load(
    './dog_face/models/dog/dog_tongue.json',
    function (geometry) {
      geometry.computeMorphNormals();
      const mat = new THREE.FlexMaterial({
        map: new THREE.TextureLoader().load('./dog_face/models/dog/dog_tongue.jpg'),
        flexMap: new THREE.TextureLoader().load('./dog_face/models/dog/flex_tongue_256.png'),
        alphaMap: new THREE.TextureLoader().load('./dog_face/models/dog/tongue_alpha_256.jpg'),
        transparent: true,
        morphTargets: true,
        opacity: 1
      });
