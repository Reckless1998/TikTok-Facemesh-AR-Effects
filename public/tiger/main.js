...
function init_threeScene(spec){
  ...
  tigerMaskLoader.load('./tiger/TigerHead.json', function(tigerMaskGeom){
    const tigerFaceSkinMat = build_customMaskMaterial('./tiger/headTexture2.png', videoTransformMat2);
    const tigerEyesMat = build_customMaskMaterial('./tiger/white.png', videoTransformMat2);
